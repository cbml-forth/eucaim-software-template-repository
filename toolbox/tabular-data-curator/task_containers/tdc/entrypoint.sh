...
# -------------------------
# 3. Fix ownership of /app
# -------------------------
chown -R "$HOST_UID:$HOST_GID" /app/output_data || true

# -------------------------
# 4. Switch to host user and run the requested command
# -------------------------
...
echo_msg "Launching app as $HOST_USER ($HOST_UID:$HOST_GID)"
